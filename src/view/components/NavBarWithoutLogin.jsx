...
//                         <p className='hover:cursor-pointer' onClick={handleProfileUpdate}>Profile Details</p>
//                         <p className='hover:cursor-pointer' onClick={handleAddress}>Add Address</p>
//                         <p className='hover:cursor-pointer' onClick={handleResetPassword}>Reset Password</p>
//                         <p className='hover:cursor-pointer' onClick={handleOrderHistory}>Order History</p>
  ...
  return (
    <div className='flex items-center justify-center gap-10 py-5 fixed top-0 left-0 w-full bg-white z-[1000] '>
      ...
      <div className='flex items-center gap-20'>
        <div className='relative hidden md:block'>
          <input
            className='border-2 border-black rounded-lg px-3 py-2 pr-8 bg-green-300 text-black'
            placeholder='Search'
          />
          <div className='absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none'>
            <FaSearch />
